...
import (
	...
	"github.com/orestonce/ymd/ymdGin/internal/validator"
	"github.com/orestonce/ymd/ymdGin/binding"
)
...
func validateUser(c *ymdGin.Context) {
	var u User
	if err := c.ShouldBindJSON(&u); err == nil {
		c.JSON(http.StatusOK, ymdGin.H{"message": "User validation successful."})
	} else {
		c.JSON(http.StatusBadRequest, ymdGin.H{
